...
Built using **HTML**, **CSS**, and **JavaScript**, this project brings a clean design, and responsive gameplay — perfect for both fun and learning how logic-based games are built using web technologies.
